...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
	...
	public static boolean login(HttpServletResponse response, String accessToken){
		// do login
...
//	public  boolean ifLogin1(HttpServletRequest request){
//		String indentityInfo = CookieUtil.getValue(request, LOGIN_IDENTITY_KEY);
//
//		if (indentityInfo==null) {
//			return false;
//		}
//		Object value=redisTemplate.opsForValue().get("access:"+indentityInfo);
//		if(value==null){
//			return false;
//		}
//		return true;
