...
public class Config {
    ...
    public class Live {
         ...
         */
        public final static int APP_ID = 1257230014;

        /**
         * 云直播 APP_BIZID = 和pushSecretKey 主要用于推流地址的生成，填写错误，会导致推流地址不合法，推流请求被腾讯云直播服务器拒绝
         */
        public final static int APP_BIZID = 30173;

        /**
         * 云直播 推流防盗链key = 和 APP_BIZID 主要用于推流地址的生成，填写错误，会导致推流地址不合法，推流请求被腾讯云直播服务器拒绝
         */
        public final static String PUSH_SECRET_KEY = "d932e3b7fe20aad6c42b0ab732b931d3";

        /**
         * 云直播 API鉴权key = 和appID 主要用于common cgi请求。appid 用于表示您是哪个客户，APIKey参与了请求签名sign的生成。
         * 后台用他们来校验common cgi调用的合法性。
         */
        public final static String APIKEY = "216efb4217d82019eed49c9ff380aba6";
    ...
    public class IM {
         ...
         */
        public final static long IM_SDKAPPID = 1400128578;

        /**
         * 云通信 账号集成类型 IM_ACCOUNTTYPE = IM_SDKAPPID 和 PRIVATEKEY 是云通信独立模式下，为您的独立账户identifer，
         * 派发访问云通信服务的userSig票据的重要信息，填写错误会导致IM登录失败，IM功能不可用
         */
        public final static String IM_ACCOUNTTYPE = "36009";
        ...
        public final static String PRIVATEKEY = "-----BEGIN PRIVATE KEY-----\n" +
                "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgH4un8ZWdmwGvFuZo\n" +
                "/1Ed3fJOr0IEdQwdixN9GD5sZS+hRANCAATU2k57k6gmuDbrOQp7ppSjwyXTMBLU\n" +
                "yCPt0vAm/ZyuJVIcy529jfK4IkaLp0gcp9gwVY6AZ35VSYSsK1VJI3Ky\n" +
                "-----END PRIVATE KEY-----";
        /**
         * 云通信 验证usersig 所用的公钥
         */
        public final static String PUBLICKEY = "-----BEGIN PUBLIC KEY-----\n" +
                "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAE1NpOe5OoJrg26zkKe6aUo8Ml0zAS\n" +
                "1Mgj7dLwJv2criVSHMudvY3yuCJGi6dIHKfYMFWOgGd+VUmErCtVSSNysg==\n" +
                "-----END PUBLIC KEY-----\n";
    }
